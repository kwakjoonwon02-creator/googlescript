...
- 화면 전환마다 기울어진 3중 패널이 화면을 훑고 지나갑니다
...
| `browser` | 38 | 실제 Chromium에서 부팅 → 40 LINES 완주 → CPU 대전 → 랭킹·설정·키 리바인드 → 방 생성, **규칙 편집기·채팅·타겟팅 4종·이펙트 발생과 소멸**, 무오류 확인 |
